...
1. In the last step we confirmed our objects (tables and views) were being created in Snowflake. Now navigate back into our dbt cloud development area. To get started with development for our project, we'll need to create a new Git branch for our work. Select **create branch** and name your development branch. We'll call our branch `snowpark_python_workshop` then click **Submit**.
